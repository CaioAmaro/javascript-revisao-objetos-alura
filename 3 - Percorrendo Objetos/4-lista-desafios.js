...
//         const media = this.notas.reduce((acumulador,item)=> acumulador += item, 0) / this.notas.length;
//         return media;
//     },
//     classificarDesempenho: function(){
//         const callback = this.calcularMediaNotas();
//         console.log(`Média foi [${callback}]`);
//         if(callback >= 9){
//             return 'Seu Desempenho foi excelente!';
//         }else if(callback >= 7.5){
//             return 'Seu Desempenho foi Bom.';
//         }else if(callback >= 6){
//             return 'Seu desempenho foi regular.';
//         }else{
//             return 'Seu desempenho foi insuficiente.';
//         }
//     }
// }

// console.log(infoPessoa.classificarDesempenho());
...
//     ligar: function (){
//         if(this.ligado === true){
//             console.log('Erro: Carro já se encontra ligado!');
//         }else{
//             this.ligado = true;
...
//             console.log('Erro: Carro já se encontra desligado!');
//         }else{
//             this.ligado = false;
...
// carroComNovosDetalhes.modelo = 'Corsa';
// console.log(carroComNovosDetalhes);
